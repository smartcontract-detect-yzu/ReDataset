...
contract THB_Roulette is ERC721Enumerable, Ownable {
    ...
    function marketingMint(
        ...
        require(
            marketingSupply + _mintAmount <= marketing,
            "Cant mint more NFTs"
        );
        for (uint256 i = 1; i <= _mintAmount; i++) {
            _safeMint(_to, supply + i);
...
contract House_Wallet is Ownable {
    THB_Roulette public immutable thunderbrawlRoulette;
    ...
    address public Liqudity_Address =
        0xF051E24f6875d882DBa2eBaac5fAcACb56D87b7a;
    ...
    constructor() {
        thunderbrawlRoulette = THB_Roulette(THB_NFT_Address);
